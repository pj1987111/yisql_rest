...
import com.zhy.yisql.netty.exception.HandleRequestException;
import com.zhy.yisql.netty.exception.ResourceNotFoundException;
import com.zhy.yisql.netty.rest.convert.Converter;
import com.zhy.yisql.netty.rest.convert.ConverterFactory;
import com.zhy.yisql.netty.rest.mapping.ControllerBean;
import com.zhy.yisql.netty.rest.mapping.ControllerMapping;
import com.zhy.yisql.netty.rest.mapping.ControllerMappingParameter;
import com.zhy.yisql.netty.rest.mapping.ControllerMappingRegistry;
    ...
    private ChannelFuture writeResponse(ResponseEntity<?> responseEntity, boolean jsonResponse) throws IOException {
        ...
        if(responseEntity.getBody() != null) {
            ...
            if(responseEntity.getBody() instanceof String)
                ...
                res = JSON.toJSONString(responseEntity.getBody());
            response = new DefaultFullHttpResponse(HTTP_1_1, status, Unpooled.copiedBuffer(res, CharsetUtil.UTF_8));
        } else {
